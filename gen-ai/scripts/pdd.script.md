...
- You MUST support multiple input methods including:
  ...
  - URL: Link to resource (e.g., Quip doc, wiki page, website)
...
- You MUST include the following sections in the design document:
  ...
  - Components and Interfaces (if relevant)
  - Data Models (if relevant)
  - Error Handling
  - Testing Strategy
  - Appendices (Technology Choices, Research Findings, Alternative Approaches, context to use)
- You MUST modify the structure of the deisgn doc depending on if it is a New Feature, Refactoring, Buf Fix, Migration, etc.
